          ...
          <div className="our-products-text-button">
            <div className="aakhor-heading-parent">
              ...
              <div id="aakhor-heading-text">
                <Typography variant="h1">Aakhor</Typography>
              </div>
            ...
            <div className="aakhor-description-parent">
              <Typography variant="subtitle1" color="textSecondary">
                The backbone of আখৰ (Aakhor)'s Neural Network is typed 100% in
                Python and is based on Google's Artificial Intelligence library
                Tensorflow. আখৰ (Aakhor)'s AI model is built around almost
                600,000 combinations of Assamese words which house around
                185,000 distinct Assamese words. Our AI model can predict the
                best possible correction for any wrong Assamese word and is
                smart enough to predict the synonyms of the word too. On the
                other hand, we have used Facebook's React JS framework to create
